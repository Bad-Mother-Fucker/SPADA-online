...
1. Lavori principalmente su versioni `.md` estratte in `01_extracted/text/`
2. Se la versione `.md` è incompleta, ambigua o manca di sezioni rilevanti, riapri il file originale in `00_input/elaborati/` o `00_input/disciplinare/`
...
- Checklist criterio da `03_criteria/criteria_checklist.md`
...
- `04_doc_summaries/[codice-elaborato]_summary.md`
